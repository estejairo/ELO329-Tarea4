...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        inductor = new QPushButton(centralWidget);
        inductor->setObjectName(QString::fromUtf8("inductor"));
        inductor->setGeometry(QRect(220, 530, 151, 71));
        inductor->setStyleSheet(QString::fromUtf8(""));
        ...
        sem3 = new QLabel(centralWidget);
        sem3->setObjectName(QString::fromUtf8("sem3"));
        sem3->setGeometry(QRect(320, 60, 51, 81));
        sem3->setFrameShape(QFrame::Box);
        ...
        sem2->setFrameShape(QFrame::Box);
        sem4 = new QLabel(centralWidget);
        sem4->setObjectName(QString::fromUtf8("sem4"));
        sem4->setGeometry(QRect(490, 100, 41, 41));
        sem4->setFrameShape(QFrame::Box);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        inductor->setText(QString());
        sem3->setText(QString());
